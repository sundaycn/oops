 ...
 */
#define TXT_MNM_PTR_PULL                                                @"下拉刷新"
#define TXT_MNM_PTR_RELEASE                                             @"释放立即刷新"
#define TXT_MNM_PTR_LOADING                                             @"正在加载..."
#define TXT_MNM_PRT_LAST_UPDATE_FORMAT                                  @"上次更新时间: %@"
/*
 * Defines icon image
 */
//#define MNM_PTR_ICON_IMAGE                                              @"MNMPullToRefreshIcon.png"

@interface MCPullToRefreshView()
 ...
 */
@property (nonatomic, readwrite, assign) MCPullToRefreshViewState state;

/*
 * YES to apply rotation to the icon while view is in `MCPullToRefreshViewStatePull` state.
 */
...
@implementation MCPullToRefreshView
...
//        UIImage *iconImage = [UIImage imageNamed:MNM_PTR_ICON_IMAGE];
        ...
        [self changeStateOfControl:MCPullToRefreshViewStateIdle withOffset:CGFLOAT_MAX];
    }
...
- (void)changeStateOfControl:(MCPullToRefreshViewState)state withOffset:(CGFloat)offset {
    ...
    switch (state_) {
        ...
        case MCPullToRefreshViewStateIdle: {
        ...
        } case MCPullToRefreshViewStatePull: {
        ...
        } case MCPullToRefreshViewStateRelease: {
        ...
        } case MCPullToRefreshViewStateLoading: {
